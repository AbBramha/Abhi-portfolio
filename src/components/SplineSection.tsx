...
export default function SplineSection() {
  ...
  return (
    <section ref={sectionRef} id="about-me" className="h-screen w-full bg-[#121212] z-20 relative border-t border-white/[0.05] overflow-hidden scroll-mt-12">
      {/* Premium Glassmorphic Loading Screen */}
      {!loaded && (
        <div className="absolute inset-0 z-35 flex flex-col items-center justify-center bg-[#121212] transition-opacity duration-500">
      ...
      <div className="w-full h-full relative z-20">
        {mounted && isVisible && (
          <Spline 
            scene="https://prod.spline.design/EfScez8RmKn3nccq/scene.splinecode" 
